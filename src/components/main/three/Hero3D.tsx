...
function Model({ url }: { url: string }) {
  ...
  return <primitive object={scene} scale={10} position={[0, -2, 0]} rotation={[0.3, 0, 0]}  />;
}


export function Hero3D() {
  const modelUrl = "/models/hero_model/scene.gltf";


  return (
    <div className="w-full h-[400px] mt-[-100px] relative">
